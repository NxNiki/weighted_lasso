...
#mf.catvbm_alff_reho_dti.aal = scale(cbind(cat.vbm.neuromorph, alff.aal, reho.aal,
#                                                                 label.fa, tract.fa, label.md, tract.md))

mf.catvbm_alff_reho_dti.bn246 = scale(cbind(cat.vbm.neuromorph, alff.bn246, reho.bn246,
                                                                 label.fa, tract.fa, label.md, tract.md))

#mf.catvbm_falff_reho_dti.aal = scale(cbind(cat.vbm.neuromorph, falff.aal, reho.aal, 
#                                                                  label.fa, tract.fa, label.md, tract.md))
